    ...
    >
      <GlassCard className="w-full rounded-2xl p-8 border border-white/[0.05] shadow-2xl relative overflow-hidden backdrop-blur-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-white/40">Enter your credentials to access the terminal</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center pl-1 pr-1">
              <label className="text-xs font-semibold text-white/50 tracking-wider uppercase">Password</label>
              <Link to="#" className="text-xs text-[#00F0FF] hover:text-[#00F0FF]/80 transition-colors">Forgot?</Link>
            </div>
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <span className="text-xs text-white/20 font-mono">OR CONTINUE WITH</span>
          <div className="h-px flex-1 bg-white/5" />
        </div>

        <div className="mt-6 flex gap-4">
          <button className="flex-1 flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl py-3 transition-colors text-sm font-semibold text-white/80">
        ...
        <p className="mt-8 text-center text-xs text-white/40">
          New to Vertex?{' '}
          <Link to="/signup" className="text-[#00F0FF] hover:text-[#00F0FF]/80 hover:underline transition-all">
            Request Access
          </Link>
        </p>
      </GlassCard>
